...
最后修改`_config.butterfly.yml`中`preloader`选项, 改完以后`source: 1`为满屏加载无pace胶囊,`source: 2`为pace胶囊无满屏动画, `source: 3`是两者都启用。<psw>（这边懒得说就搬运的鱼佬那加载动画的教程了。。。。。反正都一样。。。。。）</psw>
