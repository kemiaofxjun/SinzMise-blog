...
.main-header {
  ...
  .main-nav {
    ...
    width: 100vw;
    height: 60px;
    background: linear-gradient(.25turn, transparent, var(--main-card-background) 15%), var(--triangle-background);
    ...
    &.top {
      background: linear-gradient(.25turn, transparent, var(--main-card-background) 25%), var(--triangle-background);
      outline: 0px;
      &::after {
        opacity: 0;
      }
