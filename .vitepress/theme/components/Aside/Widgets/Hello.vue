...
<template>
  <div class="hello s-card" @mouseleave="resetHello">
    ...
    <div class="content">
      <div class="site-logo">
        <img class="clock" :src="theme.siteMeta.author.cover">
      </div>
    ...
    <div class="info">
      ...
      <div class="link">
        <a href="https://github.com/kemiaofxjun" target="_blank" class="social-link">
          <i class="iconfont icon-github"></i>
        </a>
        <a href="mailto:me@mail.kemeow.top" target="_blank" class="social-link">
