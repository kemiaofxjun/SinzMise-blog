<!-- 文章页面 -->
<template>
  <div v-if="postMetaData" class="post h-entry">
    <div class="post-meta">
      <div class="meta">
      ...
      <div class="other-meta">
        <!-- 作者（不显示） -->
        <span class="author meta" style="display:none">
          <a class="p-author h-card" :href="theme.siteMeta.author.link">{{theme.siteMeta.author.name}}</a>
        </span>
        <span class="meta date">
          <i class="iconfont icon-date" />
          <time class="dt-published" :datetime="formatTime(postMetaData.date)">{{ formatTimestamp(postMetaData.date) }}</time>
        </span>
        <span class="update meta">
          <i class="iconfont icon-time" />
          <time class="dt-published" :datetime="formatTime(page?.lastUpdated || postMetaData.lastModified)">{{ formatTimestamp(page?.lastUpdated || postMetaData.lastModified) }}</time>
        </span>
        <!-- 热度 -->
        <span class="hot meta">
...
<script setup>
import { formatTimestamp, formatTime } from "@/utils/helper";
